...
- [x] Test: `test_health_includes_version()` - Health check includes app version
- [x] Implement: Add version field to health response
- [x] Run: `uv run pytest tests/webui/test_server.py::test_health_includes_version -v`
