...
def main(
    ...
    if install_completions:
        from src.cli.install_completions import install
...
def cron_start() -> None:
    ...
    from src.cli.cron import start_daemon
...
def cron_stop() -> None:
    ...
    from src.cli.cron import stop_daemon
...
def cron_status() -> None:
    """Check daemon status."""
    from src.cli.cron import daemon_status
...
def cron_reload() -> None:
    ...
    from src.cli.cron import reload_daemon
...
def memory_status() -> None:
    ...
    from src.cli.memory import status_command
