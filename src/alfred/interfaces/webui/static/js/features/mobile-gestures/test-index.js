...
test("exports shouldHandleTouch", () => {
  assert(
    typeof MobileGestures.shouldHandleTouch === "function",
    "shouldHandleTouch should be a function",
  );
});

test("exports shouldEnableGestures", () => {
  assert(
    typeof MobileGestures.shouldEnableGestures === "function",
    "shouldEnableGestures should be a function",
  );
});
...
test("exports SwipeDetector", () => {
  assert(
    typeof MobileGestures.SwipeDetector === "function",
    "SwipeDetector should be a class/function",
  );
});
...
test("exports initializeGestures", () => {
  assert(
    typeof MobileGestures.initializeGestures === "function",
    "initializeGestures should be a function",
  );
});
