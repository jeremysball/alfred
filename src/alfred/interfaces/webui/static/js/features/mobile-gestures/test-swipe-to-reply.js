...
test('snap_back_on_insufficient_swipe', () => {
  ...
  const shouldReply = swipeReply._handleSwipeEnd(messageEl, { direction: 'right', distance: 50 }, 'msg-123');
...
test('trigger_reply_on_sufficient_right_swipe', () => {
  ...
  const shouldReply = swipeReply._handleSwipeEnd(messageEl, { direction: 'right', distance: 100 }, 'msg-456');
...
test('reply_icon_appears_during_swipe', () => {
  ...
  const icon = messageEl.querySelector('.swipe-reply-icon');
