...
def test_resume_command_structure():
    ...
    message = CommandExecuteMessage(type="command.execute", payload=CommandExecutePayload(command="/resume abc123"))
...
def test_sessions_command_structure():
    ...
    message = CommandExecuteMessage(type="command.execute", payload=CommandExecutePayload(command="/sessions"))
...
def test_session_command_structure():
    ...
    message = CommandExecuteMessage(type="command.execute", payload=CommandExecutePayload(command="/session"))
...
def test_context_command_structure():
    ...
    message = CommandExecuteMessage(type="command.execute", payload=CommandExecutePayload(command="/context"))
